...
export class ApiResponseHelper {
  ...
  static authorizationError(message: string = 'Acesso negado'): ErrorResponse {
...
export const successWithPagination =
  ApiResponseHelper.successWithPagination.bind(ApiResponseHelper);
export const error = ApiResponseHelper.error.bind(ApiResponseHelper);
export const validationError =
  ApiResponseHelper.validationError.bind(ApiResponseHelper);
export const authenticationError =
  ApiResponseHelper.authenticationError.bind(ApiResponseHelper);
export const authorizationError =
  ApiResponseHelper.authorizationError.bind(ApiResponseHelper);
...
export const internalError =
  ApiResponseHelper.internalError.bind(ApiResponseHelper);
export const serviceUnavailable =
  ApiResponseHelper.serviceUnavailable.bind(ApiResponseHelper);
